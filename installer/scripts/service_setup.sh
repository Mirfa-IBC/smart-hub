...
install_custom_packages() {
    ...
    "$INSTALL_DIR/venv/bin/pip" install "$INSTALL_DIR/downloads/ctranslate2-4.5.0-cp310-cp310-linux_aarch64.whl" --no-cache-dir
    "$INSTALL_DIR/venv/bin/pip" install "$INSTALL_DIR/downloads/torch-2.5.0a0%2B872d972e41.nv24.08.17622132-cp310-cp310-linux_aarch64.whl" --no-cache-dir
    "$INSTALL_DIR/venv/bin/pip" install "$INSTALL_DIR/downloads/torchaudio-2.5.0a0%2B56bc006-cp310-cp310-linux_aarch64.whl" --no-cache-dir
